...
public class TTableSortCellEditor extends AbstractCellEditor
     ...
     * @param table TTable
     */
    public TTableSortCellEditor(TTableSort table)
    {
        this(table,"String");
    }
    /**
     ...
     * @param type String
     */
    public TTableSortCellEditor(TTableSortBase table,String type)
    {
        setTable(table);
    ...
    public class EditorDelegate implements ActionListener, ItemListener, Serializable {
        ...
        public void createComponent(String type,int row,int column)
        {
            ...
            if("String".equalsIgnoreCase(type))
            {
                ...
                text.setTableSort((TTableSort)getTable());
                setComponent(text);
                return;
            }
            ...
            if(type.startsWith("combo|"))
            {
                ...
                combo.tableSortBase = getTable().getTable();
                setComponent(combo);
                return;
            }
            ...
            if(c instanceof TComboBox)
                ((TComboBox)c).tableSortBase = getTable().getTable();
            if(c instanceof TTextFormat)
                ((TTextFormat)c).tableSortBase = getTable().getTable();
            //自定义组件
            setComponent(c);
        }
        /**
        ...
        public void actionPerformed(ActionEvent e) {
            TTableSortCellEditor.this.stopCellEditing();
        }
