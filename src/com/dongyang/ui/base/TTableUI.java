...
public class TTableUI extends TableUI
{
//
// Instance Variables
//
...
//
    ...
    private static class Actions extends UIAction
    {
                                                ...
                                                ListSelectionModel csm)
        {
            ...
            } while (stayInSelection &&
                     !table.isCellSelected(leadRow, leadColumn));
        ...
        public boolean isEnabled(Object sender)
        {
            ...
            if (sender instanceof JTable &&
                Boolean.TRUE.equals(((JTable) sender).getClientProperty(
                    "Table.isFileList")))
            {
                if (key == NEXT_COLUMN ||
                    key == NEXT_COLUMN_CELL ||
            ...
            } else if (key == ADD_TO_SELECTION && sender instanceof JTable)
            {
                ...
                return!(table.isEditing() ||
                        table.isCellSelected(leadRow, leadCol));
            }
...
//
            ...
            PropertyChangeListener
    {
        ...
        {
            JTable table = TTableUI.this.table;
            if (table == null)
                return false;
            ...
            JTable table = TTableUI.this.table;
                ...
                if (editor == null || editor.shouldSelectCell(e))
                {
                    ...
                    if (ctrl && e.isShiftDown())
                    {
                        ...
                        ListSelectionModel cm = table.getColumnModel().
                                                getSelectionModel();
                    ...
                    {
                        table.changeSelection(row, column, ctrl,
                                              !ctrl && e.isShiftDown());
                    }
                }
...
//  Installation
    ...
    protected void installDefaults()
    {
        ...
        {
            table.setSelectionBackground(UIManager.getColor(
        ...
        {
            table.setSelectionForeground(UIManager.getColor(
    ...
    {
        TLazyActionMap.installLazyActionMap(table, TTableUI.class,
                                           "Table.actionMap");
    ...
    static void loadActionMap(TLazyActionMap map)
    {
...
//    private static final TableDragGestureRecognizer defaultDragRecognizer = new
