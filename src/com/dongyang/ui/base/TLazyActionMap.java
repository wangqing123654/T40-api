 ...
 * @author Scott Violet
 */
public class TLazyActionMap extends ActionMapUIResource {
    /**
    ...
    static void installLazyActionMap(JComponent c, Class loaderClass,
        ...
        if (map == null) {
            map = new TLazyActionMap(loaderClass);
    ...
    private TLazyActionMap(Class loader) {
        _loader = loader;
    }
        ...
        if (_loader != null) {
            ...
            try {
                Method method = klass.getDeclaredMethod("loadActionMap",
                                      new Class[] { TLazyActionMap.class });
