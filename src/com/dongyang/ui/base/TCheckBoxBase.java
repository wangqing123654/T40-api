...
public class TCheckBoxBase extends JCheckBox implements TComponent{
    /**
     * 基础事件
     */
    ...
    protected void uiInit() {
        setBackground(TUIStyle.getCheckBoxBackColor());
        setTFont(TUIStyle.getCheckBoxDefaultFont());
    }
