...
public class TTabbedPaneUI extends TabbedPaneUI implements SwingConstants {
...
// Transient variables (recalculated each time TabbedPane is layed out)
    ...
    protected Rectangle closeIconRects[] = new Rectangle[0];
...
// Private instance data
    ...
    TTabbedPaneBase table;
    public TTabbedPaneUI(TTabbedPaneBase table)
    {
        this.table = table;
    }
...
// UI Rendering
    ...
    protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
        ...
        for (int i = runCount - 1; i >= 0; i--) {
            ...
            for (int j = start; j <= end; j++) {
                if (j != selectedIndex && rects[j].intersects(clipRect)) {
                    paintTab(g, tabPlacement, rects, j, closeIconRects, iconRect, textRect);
                }
            }
        }
        ...
        if (selectedIndex >= 0 && rects[selectedIndex].intersects(clipRect)) {
            paintTab(g, tabPlacement, rects, selectedIndex, closeIconRects, iconRect, textRect);
        }
    }

    protected void paintTab(Graphics g, int tabPlacement,
                            Rectangle[] rects, int tabIndex, Rectangle[] closeIconRects,
                            Rectangle iconRect, Rectangle textRect) {
        Rectangle tabRect = rects[tabIndex];
        Rectangle closeIconRect = closeIconRects[tabIndex];
        int selectedIndex = tabPane.getSelectedIndex();
        ...
        //System.out.println("==tabPane title=="+title);
        Font font = tabPane.getFont();
        //FontMetrics metrics = SwingUtilities2.getFontMetrics(tabPane, g, font);
        //$$================Modified by lx 20120220========================$$//
        FontMetrics metrics=tabPane.getFontMetrics(font);
      
        
        Icon icon = getIconForTab(tabIndex);
        Icon closeIcon = getCloseIconForTab(tabIndex);

        layoutLabel(tabPlacement, metrics, tabIndex, title, closeIcon, icon,
                    tabRect, closeIconRect,iconRect, textRect, isSelected);
        ...
        paintCloseIcon(g,closeIcon,closeIconRect);
    ...
    protected void layoutLabel(int tabPlacement,
                               ...
                               String title, Icon closeIcon,Icon icon,
                               Rectangle tabRect, Rectangle closeIconRect,Rectangle iconRect,
        ...
        if(closeIcon != null)
        {
            ...
            int w1 = (w + 2) / 2;
            closeIconRect.setBounds(iconRect.x - w1, iconRect.y, w,
        ...
        if(closeIcon != null)
        {
            closeIconRect.x += xNudge;
            closeIconRect.y += yNudge;
        }
    }
    ...
    protected void paintCloseIcon(Graphics g,Icon icon,Rectangle iconRect)
    {
        if (icon != null) {
            icon.paintIcon(tabPane, g, iconRect.x, iconRect.y);
        }
    ...
    protected void paintText(Graphics g, int tabPlacement,
        ...
        if (v != null) {
            ...
            if (tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
                ...
                g.setColor(fg);
                //$$================Modified by lx 20120220========================$$//
                //System.out.println(" enable title==================="+title);
                //tabPane.setForegroundAt(tabIndex, Color.black);
                //tabPane.setTitleAt(tabIndex, title);
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement,
                                      ...
                                      boolean isSelected ) {
        if (isSelected)
            fillTransitionH(x, y, w, h, //x + 1, y + 1, w - 3, h - 1,
                            new Color(255, 255, 255),
                            new Color(255, 255, 185), tabIndex, tabPlacement, g);
        else
            fillTransitionH(x, y, w, h, //(x + 1, y + 1, w - 3, h - 1,
                            new Color(221, 230, 247),
                            new Color(138, 168, 228), tabIndex, tabPlacement, g);
    ...
    protected void paintContentBorder(Graphics g, int tabPlacement, int selectedIndex) {
        ...
        g.setColor(new Color(59, 97, 156));
...
// TabbedPaneUI methods
    ...
    public boolean tabForCloseCoordinate(JTabbedPane pane, int x, int y,int index)
    {
        if(index == -1)
            return false;
        if(((TTabbedPane)pane).getCloseIcon() == null)
            return false;
        return closeIconRects[index].contains(x, y);
    }
...
// BasicTabbedPaneUI methods
    ...
    protected void assureRectsCreated(int tabCount) {
        ...
        if (tabCount != rectArrayLen ) {
            ...
            Rectangle[] tempCloseRectArray = new Rectangle[tabCount];
            System.arraycopy(closeIconRects, 0, tempCloseRectArray, 0,
                             Math.min(rectArrayLen, tabCount));
            rects = tempRectArray;
            closeIconRects = tempCloseRectArray;
            for (int rectIndex = rectArrayLen; rectIndex < tabCount; rectIndex++) {
                rects[rectIndex] = new Rectangle();
                closeIconRects[rectIndex] = new Rectangle();
            }
        }
    ...
    protected Icon getCloseIconForTab(int tabIndex)
    {
        return ((TTabbedPane)tabPane).getCloseIcon();
    }
    /**
   ...
   boolean requestFocusForVisibleComponent() {
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            TTabbedPaneUI ui = (TTabbedPaneUI)pane.getUI();
            if (ui == null) {
                return;
            }
            if (key == NEXT) {
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            TTabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(),
...
// Controller: event listeners
    ...
    private class Handler implements ChangeListener, ContainerListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (name == "mnemonicAt") {
                ...
                TTabbedPaneUI.this.uninstallUI(pane);
                TTabbedPaneUI.this.installUI(pane);
    ...
    public void fillTransitionH(int x, int y, int width, int height,
                                Color c1,
                                Color c2, int tabIndex, int tabPlacement,
                                Graphics g)
    {
        if (tabPlacement == BOTTOM)
            y--;
        if (tabPlacement == RIGHT)
            x--;
        Color c = new Color(59, 97, 156);
        Color cc = new Color(255, 255, 255);
        Color bc = table.getTabColor(tabIndex);
        if (bc != null)
        {
            g.setColor(bc);
            ...
            for (int i = 0; i < height; i++)
            {
                ...
                int G = (int) (c1.getGreen() -
                               (c1.getGreen() - c2.getGreen()) * d);
