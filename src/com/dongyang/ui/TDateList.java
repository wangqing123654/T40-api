...
public class TDateList extends TDateListBase
{
    /**
     * UI适配器
     */
    ...
    public void createInit(TObject object)
    {
        if(object == null)
            return;
        object.setValue("Width","166");
        object.setValue("Height","117");
        object.setValue("BKColor","白");
        object.setValue("Border","凹");
    }
    /**
     * 得到属性列表
    ...
    public TAttributeList getAttributes()
    {
        ...
        data.add(new TAttribute("Border","String","凹","Left"));
        data.add(new TAttribute("color","String","黑","Left"));
        data.add(new TAttribute("BKColor","String","白","Left"));
        data.add(new TAttribute("CursorType","int","0","Right"));
        data.add(new TAttribute("Action","String","","Left"));
        data.add(new TAttribute("Year","int","2009","Right"));
        data.add(new TAttribute("Month","int","2","Right"));
        data.add(new TAttribute("Day","int","1","Right"));
    ...
    public void setAttribute(String name,String value)
    {
        ...
        {
            setYear(StringTool.getInt(value));
            getTObject().setValue("Year",value);
            return;
        }
        if("Month".equalsIgnoreCase(name))
        {
            setMonth(StringTool.getInt(value));
            getTObject().setValue("Year",value);
            return;
        }
        if("Day".equalsIgnoreCase(name))
        {
            setDay(StringTool.getInt(value));
            getTObject().setValue("Day",value);
            return;
        }
